  ...
  .container.tarjeta.tarjeta--blanca.px-4.px-md-5.pt-4.pt-md-5
    ...
    .row.mb-4
      .col-lg-8
        ...
        p(data-aos="fade-left") A lo largo del recorrido, se explorará el uso de materiales manipulativos, tecnologías digitales y experiencias cotidianas para fortalecer los procesos numéricos, espaciales, métricos, aleatorios y variacionales en la educación infantil. Se espera que, al finalizar la unidad, cada estudiante sea capaz de diseñar y aplicar estrategias didácticas que estimulen el pensamiento matemático en los niños y niñas, promoviendo aprendizajes significativos y duraderos.
